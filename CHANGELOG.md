...
- README install instructions now use the PyPI package
  (``pip install mchammer-pt``) and document the ``custom-moves`` extra,
  replacing the editable-from-clone instructions.
...
- ``mchammer-pt-reassemble`` CLI: unions the complementary window-subset
  ...
  (the same window in two inputs), pointing the user at
